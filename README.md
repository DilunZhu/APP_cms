...
采用“社交+收藏”的模式，既以产品自身不俗的功能来满足用户基本的以及更深层次的收藏需求，又以每一位用户的收藏为纽带，连接人与人之间的交流和分享。
### 1.2 产品理念
让用户可以更方便地聚集自己在多个平台收藏的内容，让他们可以在想要查看某个自己收藏过的内容时，不用在不同的平台之间东奔西跑，以及能够更高效地利用起自己的收藏夹，减少收藏吃灰的情况。

并且，Galaxy希望通过“社交+收藏”的模式，来打造一个资源共享的社区，让更多有内涵、有意思、有价值的内容能够被广泛传播，让更多的人发现它们。
### 1.3 产品核心目标
利用自身独特的功能，帮助用户聚合多个平台的收藏夹内容，也就是将分散的收藏内容集中于一处。收藏的内容包括但不限于图片、视频、文章、文件等等。

Galaxy将会对这些内容进行智能化分类，根据其内容自动生成相应的标签，并将收藏的内容合理有序地整合排放。

与此同时，Galaxy融入社交属性，让收藏夹可以分享于大众，在一定程度上优质资源的共享。

最终的目标则是要让Galaxy成为用户心中不可多得的收藏类APP，使其能够在众多同类APP中脱颖而出。
### 1.4 产品亮点  
- 1.能够聚合多个平台的收藏内容，将它们集中在一处；
- 2.可以为收藏内容生成标签，用户可以通过点击标签查看其它拥有同样标签的内容；
- 3.实现智能化整理归纳收藏内容，让收藏夹变得整洁有序，易于查阅；
- 4.可以对重要收藏内容添加标记，设置提醒功能，帮助用户有意识地去查看这些重要的内容；
- 5.附带许多社交功能，例如分享自己的收藏夹、对他人的收藏夹进行评论或收藏。
### 1.5 产品核心功能 
- 1.既可以收藏来自本地的图片、视频、文章、文件等内容，也可以收藏来自其它平台的内容；
- 2.对内容生成标签，用户可以通过点击标签来寻找同类型的内容；
- 3.智能化整理收藏夹，将收藏的内容进行分类，让收藏夹变得整洁有序，易于用户浏览；
- 4.可以对重要的收藏内容打上标记，提醒用户此项内容的重要性；
- 5.用户可以对其认为有价值的收藏内容设置提醒，促使用户去查看这部分的内容，帮助用户减少收藏吃灰的情况；
- 6.用户可以分享自己的收藏夹，也可以收藏、评论他人的收藏夹。
## 二、目标市场
### 2.1 市场与行业规模
- ***社交软件市场规模***
...
![中国移动社交行业规模研究](md_images/中国移动社交行业规模研究.jpeg)
...
![用户使用社交产品的渠道较为固定](md_images/用户使用社交产品的渠道较为固定.jpeg)
...
![熟人社交仍为主流](md_images/熟人社交仍为主流.jpeg)
...
### 3.4 用户画像与描述
![1](md_images/用户画像1.jpg)
![1](md_images/用户画像2.jpg)
...
# 👩🏻‍💻 CMS产品信息设计
### 产品架构图
![产品架构图](md_images/产品架构图.png)
### 权限架构图
![权限架构图](md_images/权限架构图.png)

---
# 🔍 参与贡献

成员陈梓基： 
1. 完成CMS产品PRD文档的后台权限架构图与后台网站产品架构图
2. 与朱迪伦合作完成CMS产品界面
3. 与朱怡静、聂俊杰、朱迪伦合作撰写平静技术设计原则
4. 负责“搜索”全模块的交互说明

成员朱迪伦：  
1. 完成前端产品PRD文档的产品框架图与主要功能使用流程图
2. 与陈梓基合作完成CMS产品界面
3. 与朱怡静、聂俊杰、陈梓基合作撰写平静技术设计原则
4. 负责“首页”全模块的交互说明
5. 完成CMS产品如何人工介入前端产品的交互逻辑

成员肖亮书：  
1. 与李嘉浩合作完成MRD文档-竞品分析部分
2. 负责完成前端产品的全部交互功能

成员杨培君：  
1. 完成MRD文档-目标市场部分
2. 与朱怡静、李嘉浩合作完成前端产品界面（收藏内容详细页、发现页、“添加收藏”全模块）
3. 负责“添加收藏”全模块的交互说明

成员朱怡静：  
1. 完成MRD文档-用户分析部分
2. 与杨培君、李嘉浩合作完成前端产品界面（收藏内容详细页、发现页、“我的”全模块）
3. 与朱迪伦、聂俊杰、陈梓基合作撰写平静技术设计原则
4. 负责“我的”全模块的交互说明

成员聂俊杰：  
1. 完成MRD文档-产品定位部分
2. 负责完成CMS的全部交互功能
3. 与朱迪伦、朱怡静、陈梓基合作撰写平静技术设计原则

成员李嘉浩：  
1. 与肖亮书合作完成MRD文档-竞品分析部分
2. 与杨培君、朱怡静合作完成前端产品界面（收藏内容详细页、关注页、搜索页）
